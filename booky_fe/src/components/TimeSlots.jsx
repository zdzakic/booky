        ...
        {slots.map(s => (
          <button
            ...
            className={
              s.available
                ? s.time === selectedTime
                  ? 'py-2 px-3 rounded-xl border bg-orange-600 text-white border-orange-600'
                  : 'py-2 px-3 rounded-xl border bg-white text-gray-800 hover:border-orange-400'
                : 'py-2 px-3 rounded-xl border bg-gray-100 text-gray-400 cursor-not-allowed'
            }
          >
            {s.time}
          </button>
