...
from .views import ServiceTypeListAPIView, TimeSlotListAPIView, ReservationListCreateAPIView, AvailableSlotsView, ReservationDestroyAPIView, ReservationListAPIView, AllSlotsStatusAPIView
